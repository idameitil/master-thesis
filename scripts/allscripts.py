...
def generate_weights(batch_size, n_hid, new):
    if new == 1:
        ...
        np.save("/home/ida/TCR-p-MHC/data/m1.npy", m1)
        np.save("/home/ida/TCR-p-MHC/data/m2.npy", m2)

    elif glob.glob("/home/ida/TCR-p-MHC/data/m1.npy") and glob.glob("/home/ida/TCR-p-MHC/data/m2.npy"):
        print("Loading m1, m2")
        #m1 = torch.from_numpy(np.load("/home/ida/TCR-p-MHC/data/m1.npy")).cuda()
        #m2 = torch.from_numpy(np.load("/home/ida/TCR-p-MHC/data/m2.npy")).cuda()
        m1 = torch.from_numpy(np.load("/home/ida/TCR-p-MHC/data/m1.npy"))
        m2 = torch.from_numpy(np.load("/home/ida/TCR-p-MHC/data/m2.npy"))
